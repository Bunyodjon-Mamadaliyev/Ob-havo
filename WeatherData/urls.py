...
from .views import (WeatherDataCreateAPIView, WeatherDataUpdateAPIView, WeatherDataLocationAPIView,
...
urlpatterns = [
    ...
    path('weather-data/location/<int:location_id>/', WeatherDataLocationAPIView.as_view(), name='weather-data-by-location'),
    # ANALYTICS (Tahlillar)
    ...
    path('analytics/wind_speed-max/', WindSpeedMaxAPIView.as_view(), name='wind-speed-max'),
]
